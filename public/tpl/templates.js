 ...
 *  question_text : string, score : int, comment_count: int, comments: Array}
 *
 * @type {string}
 */
...
var topQuestionHtml =
 '<div id=\"0\" class=\"{{classes}}\"><div class=\"question-content\">' +
 '<p>{{{question_text}}}</p><br></div>' +
 '<div class=\"row question-controls\"><a href=\"#\" id=\"thumbs-down-to-active\">'+
 '<i class=\"fa fa-thumbs-o-down fa-2x col-md-1 col-sm-1 col-xs-1 col-lg-1\"></i></a>' +
 '<p class=\"num-votes col-md-1 col-sm-1 col-xs-1 col-lg-1\">{{score}}</p>' +
 '<a href=\"#\" id=\"thumbs_up_to_active\"><i class=\"fa fa-thumbs-o-up fa-2x col-md-1 col-sm-1 col-xs-1 col-lg-1\"></i></a>' +
 '<p class=\"num-comments col-md-offset-6 col-sm-offset-4 col-xs-offset-6 col-md-1 col-sm-1 col-xs-1 col-lg-1\">{{comment_count}}</p>' +
 '<a href=\"#\" id=\"comment-to-active\"><img src=\"/images/comment.png\" class=\"col-md-1 col-sm-2 col-xs-2 col-lg-1 comment \"></a>' +
 '<a href=\"#\" id=\"comment-to-inactive\">' +
 '<img src=\"/images/comment_active.png\" class=\"col-md-1 col-sm-1 col-xs-1 col-lg-1 comment com-active\"></a>' +
 '</div><!--end topquestion_section-->' +
 '<div class=\"comment-section\"><a href=\"#\" id=\"more\">view more comments</a>' +
 '<p>Go back and take CSE 12 with Gary!</p>' +
 '<p> ^^^ I agree...Gary is the best!</p>' +
 '<p>If it wasn\'t for Gary, I wouldn\'t even know what a variable is...</p>' +
